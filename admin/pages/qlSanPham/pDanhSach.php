<form id="frmTimKiem" name="frmTimKiem" method="post" action="index.php?c=2&a=4" enctype="multipart/form-data">
...
<table cellspacing="0" border ="1" id="tb">
    ...
    <?php 
        ...
        s.MaLoaiSanPham =l.MaLoaiSanPham AND s.MaHangSanXuat = h.MaHangSanXuat  ORDER BY s.MaSanPham DESC";
